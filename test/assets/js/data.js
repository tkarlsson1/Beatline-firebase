(function () {
  ...
  /**
   * Renderar spellistor i modalen "managePlaylistsModal".
   * Förväntar sig ett objekt: { "Min lista": { songs: {...} } | { count: <num> } | Array }
   */
  function renderPlaylists(listMap) {
    ...
    if (!container) return; // inget att rendera i
